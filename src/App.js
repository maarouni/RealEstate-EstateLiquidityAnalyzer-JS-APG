...
<TextInput label="GO Name" value={goName} onChange={setGoName} placeholder="GO name"/>
</div>
</div>
</div>
...
{[...scenarios].sort((a,b)=>b.legacy-a.legacy)[0].name}
</strong> — Settlement Costs{" "}
{fmt([...scenarios].sort((a,b)=>b.legacy-a.legacy)[0].totalCosts)} |{" "}
Legacy to Heirs{" "}
{fmt([...scenarios].sort((a,b)=>b.legacy-a.legacy)[0].legacy)}
</div>
</div>
